...
function taskActionButton(action, label, extra = "") {
	return `<button type="button" class="rux-button rux-button--ghost rux-button--icon sched-tasks__shortcut" data-task-action="${action}" ${extra} aria-label="${label}" title="${label}">
