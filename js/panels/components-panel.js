...
(function () {
	...
	function cloneLiveComponent(selector, ariaLabel) {
		...
		clone.querySelector(":scope > .rux-segmented-track__indicator")?.remove();
		delete clone.dataset.ruxIndicatorInit;
		delete clone.dataset.ruxIndicatorReady;
		clone.style.removeProperty("--_segment-indicator-x");
		clone.style.removeProperty("--_segment-indicator-y");
		clone.style.removeProperty("--_segment-indicator-width");
		clone.style.removeProperty("--_segment-indicator-height");
	...
	function mountCatalogFamilyPages() {
		...
		if (!document.querySelector('[data-component-page="feedback-status"]')) {
			...
			host.innerHTML = `
				<div class="components-app__catalog-block"><span class="rux-badge">Default</span><span class="rux-badge rux-badge--info">Info</span><span class="rux-badge rux-badge--success">Success</span><span class="rux-badge rux-badge--warning">Warning</span><span class="rux-badge rux-badge--danger">Danger</span><span class="rux-badge rux-badge--dot">Active</span></div>
				<div class="components-app__catalog-block"><span class="rux-badge rux-badge--solid">Info</span><span class="rux-badge rux-badge--success rux-badge--solid">Success</span><span class="rux-badge rux-badge--warning rux-badge--solid">Warning</span><span class="rux-badge rux-badge--danger rux-badge--solid">Danger</span><span class="rux-badge rux-badge--danger rux-badge--solid rux-badge--dot">Cancelled</span></div>
