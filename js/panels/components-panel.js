	...
	function mountCatalogFamilyPages() {
		...
		if (!document.querySelector('[data-component-page="surfaces-content"]')) {
			...
			host.innerHTML = `
				...
				<div class="components-app__surface-grid"><article class="rux-card"><header class="rux-card__header"><p class="rux-card__title">Standard card</p></header><div class="rux-card__body">Card body</div><footer class="rux-card__footer"><button class="rux-button rux-button--default rux-button--compact">Action</button></footer></article><article class="rux-card"><header class="rux-card__header"><p class="rux-card__title">Elevated card</p></header><div class="rux-card__body rux-card__body--elevated">Elevated surface</div></article><article class="rux-card rux-card--borderless"><div class="rux-card__body">Borderless card</div></article></div>
