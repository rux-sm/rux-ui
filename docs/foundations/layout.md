...
**Contract version: 2.9.0** · Stamped at the top so a downstream document can state the
version it conforms to. Authority without a version is only "whatever `main` says today,"
which is not control. See [`README.md`](README.md) §2.

**Status** · 24 steps: **24 done**
...
| Panel pane content inset | `20px`, adjusted when attached navigation owns the top seam |
