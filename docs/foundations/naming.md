...
**Status** · 14 steps: **10 done · 4 open**
...
*(R1. **Defined 2026-08-22, not yet enforced** — the definition is step 2, the **two** splits
it identifies are step 13, and the test is step 14. See §4 D1.)*
...
13. **The test is still not written**, and that is now the only thing between R1 and being
enforced rather than merely stated. Step 14 can ship it with an empty exception list, which
was the point of doing the consolidation first.
