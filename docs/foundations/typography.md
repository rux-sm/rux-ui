...
**Contract version: 1.19.1** · Stamped at the top so a downstream document can state the
version it conforms to. Authority without a version is only "whatever `main` says today,"
which is not control. See [`README.md`](README.md) §2.

**Status** · 47 steps: **35 done · 1 ready · 9 open · 2 deferred**
...
**2.14 Below 12px, tracking turns positive.** Small type needs its letters opened, not
...
12px and 14px sizes track 0. Any type below **12px** MUST carry `--rux-tracking-dense`
(**+0.02em**). This is the mirror of 2.13's negative curve at the display end, and the two
together are one curve: **+0.02em below 12, 0 at 12–20 for non-headings, and −0.02 → −0.06em
for headings as they grow.**

The threshold read *below 14* until step 37, which contradicted the Geist measurement cited
two sentences above it, `text-label-12`'s own published tracking, and 367 rendered elements.
Corrected rather than reinterpreted, because a rule whose evidence disagrees with its MUST
