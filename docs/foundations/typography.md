...
**Contract version: 6.0.0** · Stamped at the top so a downstream document can state the
version it conforms to. Authority without a version is only "whatever `main` says today,"
which is not control. See [`README.md`](README.md) §2.

**Status** · 68 steps: **64 done · 1 deferred · 3 withdrawn**
...
specimens on 2026-08-21 (49). **What is left is not conformance:** D22 (a literal `12px` in `maintenance-share.css`) is
an app-tier defect awaiting its owner (D19, the other one, was closed by `../trip-bar.md`
step 10 and its orphaned rung retired by step 68); steps 4, 23, 32, 34 and 46 wait on a consumer.
