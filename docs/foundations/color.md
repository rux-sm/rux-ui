...
**Contract version: 3.6.3** · Stamped at the top so a downstream document can state the
version it conforms to. Authority without a version is only "whatever `main` says today,"
which is not control. See [`README.md`](README.md) §2.

**Status** · 32 steps: **32 done**
...
reason. Both gamuts ship, every published text and fill pairing clears AA in the worse of
them, and rules 2.1, 2.8, 2.9 and 2.11 are executable. The legacy Tier 0 is down to
