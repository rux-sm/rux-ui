...
**Where to pick up.** **Every step is done.** The rules are stated, the roles read the
catalog, both gamuts ship, and rules 2.1, 2.8, 2.9 and 2.11 are executable rather than
aspirational — seventeen tests across three suites. What is left is not steps but **defects**,
and none of them is a conformance gap; they are this system's own leftovers.
