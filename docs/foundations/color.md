...
**Status** · 15 steps: **12 done · 3 open**
...
`CLAUDE.md`'s rule and carry their grep protocol in §5. **Step 15 turns on Q9**, a product
question about the scheduler's trip palette. **D15** is separate and needs a mechanism
