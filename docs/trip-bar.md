...
**Status:** 17 done · 0 ready · 1 open (step 15, the owner's palette decision) · 2 superseded · 4 open questions (Q3 answered) · 18 known defects (16 resolved: D1–D8, D10–D14, D16–D18; open: D9 — `state.md`'s, and D15 — `color.md`'s).
